<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Obra-Detalhe.aspx.cs" Inherits="IsoService.Obra_Detalhe" %>
        ...
        <div id="page-wrapper">
			...
			<section id="main" class="container">
				<header>
					...
					<h2><asp:Label ID="lblTituloObra" runat="server"></asp:Label></h2>
					<p style="margin:0; padding:0;"><asp:Label ID="lblDescricaoObra" runat="server"></asp:Label></p>
				</header>
                <div class="box informacoes">
                    <div class="row">
						<div class="12u informacoes-header" style="background:beige;">
					        <%--<h3>Obra Demonstração 01</h3>--%>
                            <span class="image featured informacoes-detalhe" style="margin:0 0 0.5em 0; width:100%;"><asp:Image ID="imgObra" runat="server"/></span>
					        <asp:Label ID="lblInformacoesObra" runat="server"></asp:Label><br />
                        </div>
                                    ...
                                    <asp:Repeater ID="rptImagensObra" runat="server">
                                        <ItemTemplate>
                                            <li class="4u 12u(mobilep)" style="list-style:none; text-align:center;">
                                                <asp:Image ID="imgObra" runat="server" title="Iso Service Empreendimentos" CssClass="img-responsive galeria-fotos" ImageUrl='<%# DataBinder.Eval(Container.DataItem,"_CaminhoImagem") %>'/>
                                            </li> 
                                        </ItemTemplate>
                                    </asp:Repeater>            
                                </ul>
                        ...
                        <div id="divAcompanhamentoObra" runat="server" class="12u" style="background:beige; padding:1em; margin-bottom:2em;">
					        <h3>Andamento da obra</h3>
					        <p style="margin-bottom:0.8em;">Acompanhe aqui o andamento dessa obra.</p>
                            <asp:Repeater ID="rptAcompanhamentoObra" runat="server">
                                <ItemTemplate>
                                    <div class="row" style="margin-bottom:2em;">
                                        ...
                                        <div class="8u 12u(mobilep)">
                                            <span><b>Etapa:</b> <%# DataBinder.Eval(Container.DataItem,"_Titulo") %></span><br />
                                            <span><b>Data:</b> <%# DataBinder.Eval(Container.DataItem,"_Data") %></span><br />
                                            <span><b>Situação:</b> <%# DataBinder.Eval(Container.DataItem,"_Status") %></span><br />
