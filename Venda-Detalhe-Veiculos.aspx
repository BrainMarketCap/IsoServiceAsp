<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Venda-Detalhe-Veiculos.aspx.cs" Inherits="IsoService.Venda_Detalhe_Veiculos" %>
                ...
                <div class="box informacoes">
                    <div class="row">
						<div class="12u informacoes-header" style="background:beige;">
                            ...
                            <span id="spAno" runat="server"><b>Ano:</b>&nbsp<asp:Label ID="lblAno" runat="server"></asp:Label></span><br />
                            <span id="spKilometragem" runat="server"><b>KM:</b>&nbsp<asp:Label ID="lblKilometragem" runat="server"></asp:Label></span><br />
