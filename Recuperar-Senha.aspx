<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Recuperar-Senha.aspx.cs" Inherits="IsoService.Recuperar_Senha" %>
...
<html>
    ...
    <form id="site" runat="server">
        <div id="page-wrapper">
            ...
            <a href="#" id="subir-topo"><img src="images/topo.png" alt="Topo" /></a>
			...
			<section id="main" class="container">
				<header>
					...
					<p style="margin:0; padding:0;">Utilize o formulário abaixo para recuperar a senha de acesso para a área de administração do site.</p>
				</header>
				<div class="box SobreNos">
					<div class="row">
						<div class="12u" style="margin-bottom:2em;">
                            ...
                            <p>Informe abaixo o email cadastrado para acesso a área de administraçao:</p>
                            <asp:TextBox ID="tbUsuarioEmail" runat="server" placeholder="E-mail cadastrado" required MaxLength="100"></asp:TextBox>
                            <asp:Button ID="btnRecuperarSenha" runat="server" Text="Recuperar Senha" style="background-color:#444; color:#ffffff; margin-top:1em;" onclick="btnRecuperarSenha_Click" />
                        </div>
					</div>
				</div>
			</section>
