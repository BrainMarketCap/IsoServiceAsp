<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Principais-Clientes.aspx.cs" Inherits="IsoService.Principais_Clientes" %>
        ...
        <div id="page-wrapper">
			...
			<section id="main" class="container">
				<header>
					...
					<p style="margin:0; padding:0;">Conheça os parceiros e clientes da ISO SERVICE.</p>
				</header>
				<div class="box informacoes">
                    <div class="row">
                        
                        <div id="divPrincipaisClientes" runat="server" class="12u" style="background:beige; padding:1em; margin-bottom:2em;">
                            <asp:Repeater ID="rptRegistros" runat="server">
                                <ItemTemplate>
                                    <div class="row" style="margin-bottom:2em;">
                                        <div id="divFotoCliente" runat="server" Visible='<%# Eval("_Imagem").ToString() == "" ? false : true %>' class="4u 12u(mobilep)" style="text-align:center;">
