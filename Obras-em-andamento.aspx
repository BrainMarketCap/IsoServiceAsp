<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Obras-em-andamento.aspx.cs" Inherits="IsoService.Obras_em_andamento" %>
        ...
        <div id="page-wrapper">
			...
			<section id="main" class="container">
				<header>
					...
					<p style="margin:0; padding:0;">Conheça mais sobre as obras em andamento da ISO SERVICE.</p>
				</header>
				<div class="box informacoes">
                    <div class="row">
                        <asp:Repeater ID="rptRegistros" runat="server">
                            <ItemTemplate>
						        <div class="12u" style="background:beige; padding:1em; margin-bottom:2em;">
					                <h3><asp:HyperLink ID="hlVerObraTitulo" runat="server" style="z-index: 10001; text-decoration:none; border:none;" Text='<%# DataBinder.Eval(Container.DataItem,"_Titulo") %>' NavigateUrl='<%# GetUrl(Eval("_Id"),Eval("_Titulo")) %>' ToolTip="Clique para ver detalhes da obra."></asp:HyperLink></h3>
                                    <asp:HyperLink ID="hlVerObraImagem" runat="server" NavigateUrl='<%# GetUrl(Eval("_Id"),Eval("_Titulo")) %>' ToolTip="Clique para ver detalhes da obra." style="border:none;">
                                        <%--<img src='<%# DataBinder.Eval(Container.DataItem,"_Imagem") %>' alt="..." class="informacoes-detalhe" />--%>
                                        <span class="image featured informacoes-detalhe" style="margin:0 0 0.5em 0; width:100%;"><asp:Image ID="imgObra" runat="server" src='<%# DataBinder.Eval(Container.DataItem,"_Imagem") %>' alt="..." /></span>
                                    </asp:HyperLink>
                        ...
                        <asp:Label ID="lblControlePaginacao" runat="server" Text="0" CssClass="hidden" ForeColor="#ffffff"/>
