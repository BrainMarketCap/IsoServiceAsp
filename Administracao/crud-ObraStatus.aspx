<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="crud-ObraStatus.aspx.cs" Inherits="IsoService.Administracao.crud_ObraStatus" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12" style="padding:10px 0px 20px 0px;">
                    <span class="adm-breadcrumb"><i class="glyphicon glyphicon-home" aria-hidden="true"></i><a style="border:none;" href='<%=ResolveUrl("~/Administracao") %>'> ÍNICIO > </a> <a style="border:none;" href='<%=ResolveUrl("~/Administracao/Obra-Situacao") %>'> SITUAÇÃO</a></span>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="inputTitulo" name="inputTitulo" placeholder="Título" maxlength="50" runat="server" ValidationGroup="obra" required title="Informe o título" spellcheck="true" onblur="VerificaCampoVazio(this.id);" onkeypress="BlocED(this, mED);" />
                        </div>
                    </div>
