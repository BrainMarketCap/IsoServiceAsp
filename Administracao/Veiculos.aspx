<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Veiculos.aspx.cs" Inherits="IsoService.Administracao.Veiculos" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12" style="padding:10px 0px 20px 0px;">
                    <span class="adm-breadcrumb"><i class="glyphicon glyphicon-home" aria-hidden="true"></i><a style="border:none;" href='<%=ResolveUrl("~/Administracao") %>'> ÍNICIO > </a> <a style="border:none;" href='<%=ResolveUrl("~/Administracao/Veiculos") %>'> VEICULOS</a></span>
                </div>
            </div>
        </div>
        ...
        <div class="container" style="background-color: #ffffff; border-radius:5px; box-shadow: 0 1px 1px #777; padding: 10px 20px 30px 20px; margin-top:5px;">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <%--DROPDOWNLIST / Exibir veículos: Leves / Pesados--%>
                    <div class="col-md-12" style="padding:0;">
                        <div class="form-group">
                            <div class="input-group">
                                <span class="input-group-addon">Tipo Veículo</span>
                                <asp:DropDownList ID="ddlTipoVeiculo" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlTipoVeiculo_SelectedIndexChanged"></asp:DropDownList>
                            ...
                            <asp:Repeater ID="rptRegistros" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td><asp:HyperLink ID="hlEditarRegistro" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"_Titulo") %>' NavigateUrl='<%# GetUrl(Eval("_Id"),Eval("_Titulo")) %>' ToolTip="Clique para EDITAR"></asp:HyperLink></td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>  
                            <!--//Conteudo da tabela-->    
