<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Obras.aspx.cs" Inherits="IsoService.Administracao.Obras" %>
        ...
        <div class="container" style="background-color: #ffffff; border-radius:5px; box-shadow: 0 1px 1px #777; padding: 10px 20px 30px 20px; margin-top:5px;">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <%--DROPDOWNLIST / Exibir obras: Realizadas / Em andamento--%>
                    <div class="col-md-12" style="padding:0;">
                        <div class="form-group">
                            <div class="input-group">
                                <span class="input-group-addon">Tipo Obra</span>
                                <asp:DropDownList ID="ddlTipoObra" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlTipoObra_SelectedIndexChanged"></asp:DropDownList>
