<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SobreNos.aspx.cs" Inherits="ArteFesta.Administracao.SobreNos" %>
...
<body onkeydown="return (event.keyCode!=13)">
    <form id="gerenciar" runat="server" style="min-height: calc(100% - 95px);">
        ...
        <div class="container" style="background-color: #ffffff; border-radius:5px; box-shadow: 0 1px 1px #777; padding: 10px 20px 30px 20px; margin-top:5px;">
            <div class="row">
                <div class="col-md-12">
                    <h3>Sobre nós</h3><br /><br />
                    <asp:HiddenField ID="lblIdSobre" runat="server" />
                    <%-- Texto sobre a empresa --%>
                    <div>
                        <span>Texto sobre a empresa:</span><asp:TextBox CssClass="TextBox" ID="tbSobreNos" TextMode="MultiLine" runat="server" required spellcheck="true" onkeypress="BlocED(this, mED);" ToolTip="Sobre nós"></asp:TextBox>
                    </div>
                    <div class="row" style="padding-right:15px;">
                        <asp:Button ID="btnCancelar" runat="server" CssClass="pull-right btn btn-warning" Text="Cancelar" ToolTip="Cancela a edição" style="margin-right:5px; margin-left:5px;" formnovalidate CausesValidation="False" onclick="btnCancelar_Click"/>
        ...
        <div class="container" style="background-color: #ffffff; border-radius:5px; box-shadow: 0 1px 1px #777; padding: 10px 20px 30px 20px; margin-top:25px;">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <!--Botão NOVO CADASTRO-->
                    <asp:Button ID="btnCadastrarNovo" runat="server" CssClass="pull-left btn btn-success" Text="Nova imagem" ToolTip="Cadastrar" onclick="btnCadastrarNovo_Click"/><br /><br /><br /><br />
                    <!--//Botão NOVO CADASTRO-->
                            ...
                            <asp:Repeater ID="rptRegistros" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td><asp:HyperLink ID="hlEditarRegistro" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"_Descricao") %>' NavigateUrl='<%# GetUrl(Eval("_Id")) %>' ToolTip="Clique para EDITAR"></asp:HyperLink></td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>  
                            <!--//Conteudo da tabela-->    
