<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="IsoService.Login" %>
        ...
        <div id="page-wrapper">
			...
			<section id="main" class="container">
				<header>
					...
					<h2>Login</h2>
					<p style="margin:0; padding:0;">Utilize o formulário abaixo para acessar a área de administração do site.</p>
				</header>
				<div class="box SobreNos">
					<div class="row">
						<div class="12u" style="margin-bottom:2em;">
                            ...
                            <p>Informe abaixo o email cadastrado e a senha para acesso a área de administraçao:</p>
                            <asp:TextBox ID="tbUsuarioEmail" runat="server" placeholder="E-mail cadastrado" required MaxLength="100" style="margin-bottom:1em;"></asp:TextBox>
                            <asp:TextBox ID="tbSenha" runat="server" placeholder="Senha" required MaxLength="20" TextMode="Password"></asp:TextBox>
                            <asp:Button ID="btnLogin" runat="server" Text="Acessar" style="background-color:#444; color:#ffffff; margin-top:1em;" onclick="btnLogin_Click" />
                            <!-- Esqueci minha senha -->
                            <a style="border:none; text-decoration:none; color:#444; margin-top:2em; display:block;" href='<%=ResolveUrl("~/Recuperar-Senha") %>'> Esqueci minha senha </a>
                        </div>
					</div>
				</div>
			</section>
